...
public class ComboSuggestionUI extends BasicComboBoxUI {
    ...
    public void installUI(JComponent jc) {
        ...
        UIManager.put("ComboBox.selectionForeground", comboBox.getForeground());
...
protected ListCellRenderer createRenderer() {
    return new ListCellRenderer() {
        ...
        public Component getListCellRendererComponent(JList jlist, Object e, int i, boolean isSelected, boolean bln1) {
            ...
            if (isSelected) {
                ...
                label.setBackground(Color.WHITE);  // Set the selection background to white
    ...
    private class Border extends EmptyBorder {
        ...
        private Color focusColor = new Color(255, 255, 255);
